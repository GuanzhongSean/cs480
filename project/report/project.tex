...
The parameters chosen for CatBoost (e.g., 2000 iterations, a learning rate of 0.085) were selected based on a balance between computational efficiency and model performance. The performance of each model was evaluated using the R2 score, the results are summarized in \Cref{tab:r2-scores}.

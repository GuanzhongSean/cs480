...
max_pass = 500
classifiers = per.perceptron_one_vs_one(X_train, y_train, max_pass)

y_train_pred = per.predict_one_vs_one(X_train, classifiers)
y_test_pred = per.predict_one_vs_one(X_test, classifiers)

...
max_pass = 500
weights = per.perceptron_multiclass(X_train, y_train, max_pass)

y_train_pred = per.predict_multiclass(X_train, weights)
y_test_pred = per.predict_multiclass(X_test, weights)
